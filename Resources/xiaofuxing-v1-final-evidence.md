...
> 后续状态（2026-09-01）：本文记录 0.1.0 v1 候选收尾时的证据边界。小福猩随后经 0.1.1–0.1.5 修复链完成 Windows 安装生命周期验收，0.1.5 的 installed mode、三档冷启动、真实动态 DPI、覆盖、官方卸载和同包重装均已通过；最终状态与精确回传索引见 `Resources/project-closeout-20260901.md`。本文中的“Windows 正式验收仍未执行”保留为 2026-08-28 当时结论。
