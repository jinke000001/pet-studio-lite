...
4. 使用新的非覆盖目录：`runs/phase-4-xiaofuxing-v2-kimi-20260828-01/`。
...
3. 四基准方向，用户确认。
4. 两行共 16 个注视方向、盲测和连续性检查，用户确认。
5. `1536×2288` v2 图集、`pet.json`、验证 JSON、SHA-256 和本地标准包。
6. 接入通用运行器和 Phase 3 工厂；Windows 正式验收仍在 Phase 4 完成后执行。
