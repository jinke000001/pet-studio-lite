...
contextBridge.exposeInMainWorld('workbenchApi', {
  ...
  startPetdexJob: (input) => ipcRenderer.invoke('workbench:start-petdex-job', input),
  duplicateProject: (input) => ipcRenderer.invoke('workbench:duplicate-project', input),
  revealArtifact: (input) => ipcRenderer.invoke('workbench:reveal-artifact', input),
